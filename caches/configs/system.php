...
'upload_url' => 'http://soft.hexiflower.com/uploadfile/', //附件路径
'attachment_stat' => '1',//是否记录附件使用状态 0 统计 1 统计， 注意: 本功能会加重服务器负担

'js_path' => 'http://soft.hexiflower.com/statics/js/', //CDN JS
'css_path' => 'http://soft.hexiflower.com/statics/css/', //CDN CSS
'img_path' => 'http://soft.hexiflower.com/statics/images/', //CDN img
'app_path' => 'http://soft.hexiflower.com/',//动态域名配置地址
...
'phpsso' => '1',	//是否使用phpsso
'phpsso_appid' => '1',	//应用id	
'phpsso_api_url' => 'http://soft.hexiflower.com/phpsso_server',	//接口地址
